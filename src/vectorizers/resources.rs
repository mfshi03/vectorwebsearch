...
impl SentenceEmbeddingsModulesConfigResources {
    ...
    pub const SENTENCE_GTE_BASE: (&'static str, &'static str) = (
        "sentence-gte-base/sbert-config",
        "https://huggingface.co/thenlper/gte-base/resolve/main/modules.json",
    );
}
...
impl SentenceEmbeddingsPoolingConfigResources {
    ...
    pub const SENTENCE_GTE_BASE: (&'static str, &'static str) = (
        "sentence-gte-base/sbert-config",
        "https://huggingface.co/thenlper/gte-base/resolve/main/1_Pooling/config.json",
    );
}
...
impl SentenceEmbeddingsConfigResources {
    ...
    pub const SENTENCE_GTE_BASE: (&'static str, &'static str) = (
        "sentence-gte-base/sbert-config",
        "https://huggingface.co/thenlper/gte-base/resolve/main/sentence_bert_config.json",
    );
}
...
impl SentenceEmbeddingsTokenizerConfigResources {
    ...
    pub const SENTENCE_GTE_BASE: (&'static str, &'static str) = (
        "sentence-gte-base/sbert-config",
        "https://huggingface.co/thenlper/gte-base/resolve/main/tokenizer_config.json",
    );
}
